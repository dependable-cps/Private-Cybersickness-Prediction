...
def train():
  ...
  model.add(tf.keras.layers.Embedding(input_dim=32, output_dim=128, input_length=20))
  model.add(tf.keras.layers.GRU(units=32, return_sequences=True, input_shape=(1,20)))
  ...
  with open(dir_model+"model_GRU_private.json", "w") as json_file:
    json_file.write(modelo_json)
  model.save_weights(dir_model+"model_GRU_private.h5")


  inputP0=dir_model+'input-P0-0_GRU_private'
