...
def train():
  ...
  model.add(tf.keras.layers.Conv1D(filters=32, kernel_size=10, activation = 'relu', input_shape=(20,1)))
  ...
  model.save_weights(dir_model+"model_cnn_private.h5")


  inputP0=dir_model+'input-P0-0_cnn_private'
